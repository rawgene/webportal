...
urlpatterns = [
    ...
    path('session_detail/<slug:session_slug>/data_download', views.DataDownload, name='data_download'),
    path('session_detail/<slug:session_slug>/cwl_download', views.CWLDownload, name='cwl_download'),
    path('session_detail/<slug:session_slug>/input_download', views.InputDownload, name='input_download'),
    # path('session_detail/<slug:session_slug>/send_mail', views.SendMail, name='send_mail'),
